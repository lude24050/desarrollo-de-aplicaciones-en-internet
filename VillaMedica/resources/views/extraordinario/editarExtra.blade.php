    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Actualizar Cuota Extraordinaria</div>

                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{url('/cuota/editandoExtra')}}">
                        {{ csrf_field() }}

                        <input type="hidden" name="id_ordi" value="{{$extraordinario->id_extra}}">

                        <div class="form-group">
                            <label for="name" class="col-md-4 control-label">Numero Recibo :</label>
                            <div class="col-md-6">
                                <input id="num_recibo" type="text" class="form-control" name="num_recibo" value="{{ $extraordinario->num_recibo }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="monto" type="text" class="form-control" name="monto" value="{{ $extraordinario->monto }}" required>
                            </div>
                        </div>
